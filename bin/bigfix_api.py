...
# source is https://github.com/wcmc-its/BigFix_API_dumper/bigfix_api.py
# v2.5
import requests
import re
import urllib3
...
class RelevanceQueryDumper():
    ...
    def build_relevance_query(self, fields):
        ...
        # credit to the brolly33 on the IBM community forums who came up with the structure and error handling of this query:
